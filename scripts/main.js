;(function (window) {
  ...
  let texts = ['TAP DIMANA AJA YA :)','JANGAN LUPA', 'PAKAI LANDSCAPE MODE', 'HEY', 'COBA LIAT DEH', 'KATA INI', 'KAYAKNYA ADA YANG ANEH DEH', 'AYO PENCET LAGI SUKMAA', ' SUMPAH AKU GA BOHONG KOK', 'PENCET LAGI', 'AKU TAU KHE PASTI LAGI KESEL SEKARANG', 'TAPI INI BENERAN ADA YANG ANEH SUK', 'AKU JANJI', 'INI YANG TERAKHIR', 'PENCET LAGI', 'AYO SEMANGAT', 'KHE PASTI BISA', 'KHE KURANG PENCET ITU LAGI DIKIT', 'AYO DONG', 'IYA INI BENERAN YANG TERAKHIR KOK', 'YA UDAH DEH', 'I', 'LOVE', 'YOU ♡', 'HAPPY VALENTINE DAY SUKMAA', 'BYE', 'SORRY BANGET SUK', 'KALO AKU BIKIN KHE SEDIKIT KESEL :)', 'SEMANGAT NYOBLOSNYA SENKKUUUU']
